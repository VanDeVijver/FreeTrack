        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeLabel = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    Subtitle = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    AreaSquareMeters = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudioServiceId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactInquiries_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ContactInquiries_StudioServices_StudioServiceId",
                        column: x => x.StudioServiceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactInquiries_RoomId",
                table: "ContactInquiries",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactInquiries_StudioServiceId",
                table: "ContactInquiries",
